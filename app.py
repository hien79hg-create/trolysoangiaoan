...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Thu Hiền - Trường  Tiểu học Vĩnh Tuy - ĐT: 0817585297</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Thu Hiền - Trường Tiểu học Vĩnh Tuy - ĐT: 0817585297</div>", unsafe_allow_html=True)
